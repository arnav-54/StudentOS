...
export const gradeInterviewSession = async (req: AuthenticatedRequest, res: Response) => {
...
export const optimizeResumeBullets = async (req: AuthenticatedRequest, res: Response) => {
  const { projectBullets } = req.body;
  if (!projectBullets) return res.status(400).json({ message: 'Project description bullets are required.' });
...
export const generateCoverLetter = async (req: AuthenticatedRequest, res: Response) => {
...
export const generateChatReply = async (req: AuthenticatedRequest, res: Response) => {
