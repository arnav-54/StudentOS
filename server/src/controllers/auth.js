...
export const register = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            console.warn('Prisma DB Register skipped. Writing to local memory storage instead.', dbErr.message);
            // Fallback In-Memory
...
export const login = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            console.warn('Prisma DB Login skipped. Searching local memory storage instead.', dbErr.message);
