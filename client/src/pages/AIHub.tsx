      ...
      <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="p-6 rounded-2xl border border-slate-200/60 dark:border-zinc-800/60 bg-white/75 dark:bg-[#0A0A0C]/75 backdrop-blur-xl shadow-sm hover:border-slate-300 dark:hover:border-zinc-700/80 transition-all duration-300 flex flex-col md:flex-row gap-4 items-end">
              ...
              <button
                ...
                className="w-full md:w-auto px-6 py-2.5 bg-brand-primary text-white rounded-xl text-sm font-semibold hover:bg-brand-primary/95 transition-all flex items-center justify-center gap-2"
              >
            ...
            {loadingRoadmap && (
              <div className="p-12 rounded-2xl border border-slate-200/60 dark:border-zinc-800/60 bg-white/75 dark:bg-[#0A0A0C]/75 backdrop-blur-xl shadow-sm flex flex-col items-center justify-center space-y-4">
                          ...
                          <div className="space-y-3">
                            ...
                            <ul className="space-y-2">
                              {phase.items.map((item: string, iIdx: number) => (
                                <li key={iIdx} className="flex items-start gap-2 text-xs text-slate-600 dark:text-zinc-400">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 rounded-2xl border border-slate-200/60 dark:border-zinc-800/60 bg-white/75 dark:bg-[#0A0A0C]/75 backdrop-blur-xl shadow-sm hover:border-slate-300 dark:hover:border-zinc-700/80 transition-all duration-300 space-y-4">
                    ...
                    <ul className="space-y-3">
                      {roadmapData.suggestedCourses.map((c: string, idx: number) => (
                        <li key={idx} className="p-3 border border-slate-100 dark:border-zinc-900 bg-slate-50/50 dark:bg-zinc-900/20 rounded-xl text-xs font-semibold text-slate-700 dark:text-zinc-300">
                          🎓 {c}
                        </li>
                      ))}
                    </ul>
                  ...
                  <div className="p-6 rounded-2xl border border-slate-200/60 dark:border-zinc-800/60 bg-white/75 dark:bg-[#0A0A0C]/75 backdrop-blur-xl shadow-sm hover:border-slate-300 dark:hover:border-zinc-700/80 transition-all duration-300 space-y-4">
                    ...
                    <ul className="space-y-3">
                      {roadmapData.suggestedCertifications.map((cert: string, idx: number) => (
                        <li key={idx} className="p-3 border border-slate-100 dark:border-zinc-900 bg-slate-50/50 dark:bg-zinc-900/20 rounded-xl text-xs font-semibold text-slate-700 dark:text-zinc-300">
                          🏆 {cert}
                        </li>
                      ))}
        ...
        {activeTab === 'interview' && (
          <motion.div
            ...
            className="space-y-6"
          >
            {!interviewStarted && !interviewReport && (
              <div className="p-8 rounded-2xl border border-slate-200/60 dark:border-zinc-800/60 bg-white/75 dark:bg-[#0A0A0C]/75 backdrop-blur-xl shadow-sm hover:border-slate-300 dark:hover:border-zinc-700/80 transition-all duration-300 max-w-2xl mx-auto space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-900/40 text-xs focus:outline-none focus:ring-2 focus:ring-brand-primary/50 text-slate-900 dark:text-white"
                    />
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-brand-primary hover:bg-brand-primary/95 text-white font-medium rounded-xl transition-all"
                >
                  <Sparkles className="h-4.5 w-4.5" />
            ...
            {interviewStarted && (
              <div className="p-6 sm:p-8 rounded-2xl border border-slate-200/60 dark:border-zinc-800/60 bg-white/75 dark:bg-[#0A0A0C]/75 backdrop-blur-xl shadow-sm max-w-2xl mx-auto space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Type details explaining your perspective..."
                      className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-900/40 text-xs focus:outline-none focus:ring-2 focus:ring-brand-primary/50 text-slate-900 dark:text-white font-mono"
                    />
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center">
                  <button
                    ...
                    className="px-4 py-2 border border-slate-200 dark:border-zinc-800 rounded-lg text-xs font-semibold hover:bg-slate-50 dark:hover:bg-zinc-900 disabled:opacity-40"
                  >
                    Previous
                  </button>
                  <button
                    onClick={handleNextQuestion}
                    className="px-6 py-2.5 bg-brand-primary text-white rounded-lg text-xs font-semibold hover:bg-brand-primary/95 transition-all flex items-center gap-1.5"
                  >
            ...
            {/* Loading Grader */}
            {loadingInterview && (
              <div className="p-12 rounded-2xl border border-slate-200/60 dark:border-zinc-800/60 bg-white/75 dark:bg-[#0A0A0C]/75 backdrop-blur-xl shadow-sm max-w-2xl mx-auto flex flex-col items-center justify-center space-y-4">
            ...
            {interviewReport && !loadingInterview && (
              <div className="p-6 sm:p-8 rounded-2xl border border-slate-200/60 dark:border-zinc-800/60 bg-white/75 dark:bg-[#0A0A0C]/75 backdrop-blur-xl shadow-sm max-w-2xl mx-auto space-y-6">
                <div className="flex justify-between items-center border-b border-slate-100 dark:border-zinc-900 pb-3">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-xs">
                    ...
                    <ul className="space-y-2">
                      {interviewReport.recommendations.map((rec: string, index: number) => (
                ...
                <button
                  ...
                  className="w-full px-4 py-2 border border-slate-200 dark:border-zinc-800 rounded-xl text-xs font-semibold hover:bg-slate-50 dark:hover:bg-zinc-900 transition-colors"
                >
                  Restart New Session
                </button>
              </div>
