    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-900/40 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-primary/50"
                />
              </div>
              <div>
          ...
          <div className="p-6 rounded-2xl border border-slate-200/60 dark:border-zinc-800/60 bg-white/75 dark:bg-[#0A0A0C]/75 backdrop-blur-xl space-y-4 hover:border-slate-300 dark:hover:border-zinc-700/80 transition-all duration-300 shadow-sm">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-zinc-900 pb-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1 bg-brand-accent text-white rounded-lg text-xs font-semibold hover:bg-brand-accent/90 disabled:opacity-50"
              >
            ...
            <div>
              <textarea
                ...
                placeholder="A compelling profile overview..."
                className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-900/40 text-xs text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-primary/50"
              />
            </div>
          </div>
        </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-900/40 text-xs text-slate-800 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-brand-primary"
                />
              </div>
              <div>
          ...
          <div className="p-6 rounded-2xl border border-slate-200/60 dark:border-zinc-800/60 bg-white/75 dark:bg-[#0A0A0C]/75 backdrop-blur-xl space-y-4 hover:border-slate-300 dark:hover:border-zinc-700/80 transition-all duration-300 shadow-sm">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-900/40 text-xs focus:outline-none focus:ring-1 focus:ring-brand-primary"
              />
              <button
                type="button"
                onClick={handleAddSkill}
                className="p-1.5 bg-brand-primary text-white rounded-lg hover:bg-brand-primary/90"
              >
            ...
            <div className="flex flex-wrap gap-1.5">
              {skills.map((skill) => (
                <div key={skill} className="flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-100 dark:bg-zinc-900 text-slate-600 dark:text-zinc-400 border border-slate-200/40 dark:border-zinc-800">
                  <span>{skill}</span>
        ...
        <div className="lg:col-span-3 flex justify-end">
          <button
            type="submit"
            className="flex items-center gap-2 px-6 py-2.5 bg-brand-primary text-white rounded-xl text-sm font-semibold hover:bg-brand-primary/95 transition-all"
          >
