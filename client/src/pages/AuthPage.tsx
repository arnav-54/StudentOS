  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-zinc-950 font-sans">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#09090B] relative overflow-hidden flex-col justify-between p-12 text-white border-r border-zinc-900 grid-bg">
        ...
        <div className="absolute top-1/4 left-1/4 h-80 w-80 rounded-full bg-brand-primary/10 blur-[120px] animate-float-slow" />
        <div className="absolute bottom-1/4 right-1/4 h-80 w-80 rounded-full bg-brand-accent/15 blur-[120px] animate-float-medium" />

        {/* Brand Header */}
        <div className="flex items-center gap-3 relative z-10">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-brand-primary to-brand-accent text-white shadow-lg shadow-brand-primary/20">
            <GraduationCap className="h-6 w-6" />
          </div>
          <span className="text-xl font-bold tracking-tight">StudentOS</span>
        </div>
        ...
        <div className="my-auto space-y-8 relative z-10 max-w-lg">
          ...
          >
            ...
            <h1 className="text-5xl font-extrabold tracking-tight leading-[1.1] bg-clip-text text-transparent bg-gradient-to-r from-white via-zinc-100 to-zinc-400">
          ...
          <motion.div
            ...
            className="glass-panel p-6 rounded-2xl space-y-4 border border-white/10"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="h-2 w-2 rounded-full bg-brand-success animate-ping" />
                <span className="text-xs font-medium text-slate-300">AI Placement Readiness</span>
              </div>
              <span className="text-sm font-semibold text-brand-accent">94% Ready</span>
            </div>
            <div className="space-y-2">
              <div className="h-1.5 w-full bg-zinc-800 rounded-full overflow-hidden">
                <div className="h-full w-[94%] bg-gradient-to-r from-brand-primary to-brand-accent rounded-full" />
              </div>
              <p className="text-[11px] text-zinc-400">⚡ Add 1 more certification path to maximize matching rates.</p>
            </div>
          </motion.div>
        </div>

        {/* Footer info */}
        <div className="text-xs text-zinc-500 relative z-10 flex justify-between">
        ...
        <div className="w-full max-w-md space-y-8 relative z-10">
          <div className="text-center space-y-2">
            <div className="lg:hidden flex justify-center mb-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-tr from-brand-primary to-brand-accent text-white shadow-lg">
            ...
            {showOtp ? (
              ...
              >
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-900/40 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-primary/50 text-center text-lg tracking-widest font-mono"
                    />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-brand-primary hover:bg-brand-primary/95 text-white font-medium rounded-xl transition-all duration-200 hover:scale-[1.01]"
                >
              ...
              >
                {errorMessage && (
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-brand-danger/10 border border-brand-danger/20 text-brand-danger text-sm">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-900/40 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-primary/50"
                      />
                    </div>
                  </div>
                )}
                ...
                <div>
                  <div className="flex justify-between items-center mb-1.5">
                    ...
                    {isLogin && (
                      <span className="text-xs text-brand-primary hover:underline cursor-pointer">
                        Forgot Password?
                      </span>
                    )}
                  </div>
          ...
          <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-zinc-900">
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white dark:bg-zinc-950 px-2 text-slate-400 font-medium">Or continue with</span>
            </div>

            <div className="grid grid-cols-3 gap-2">
              <button
                onClick={handleDemoAccess}
                className="flex items-center justify-center gap-1.5 px-3 py-2.5 border border-slate-200 dark:border-zinc-800 bg-slate-50 hover:bg-slate-100 dark:bg-zinc-900/40 dark:hover:bg-zinc-900 text-xs font-semibold rounded-xl text-slate-700 dark:text-zinc-300 transition-colors"
              >
                ⚡ Demo
              </button>
              <button
